...
function initBaseMap() {
	...
	popupTemplate.setTitle("CSO Projects");
	//create a feature layer based on the feature collection
	
	getGeodata("db/load.php?q=CSO_TypeID","map"); // function that involves looping though DB
	//function runs once
...
function callCreateMapsDropDownWindow(){
 ...
 function initiliazeMapVariables(){
		try{
			...
			mapStartX = 80;
			mapStartY = 10;
			//Default delta x and y movements
			mapDeltaX = 60;
			mapDeltaY = 40;
		}
...
//Checks if the the div containing conetents for the legend or pront function is hidden
